...
const ASSETS = [
  './', './index.html', './manifest.webmanifest', './css/styles.css', './css/responsive.css', './img/icon.svg', './vendor/qrcode.js', './vendor/supabase.js', './js/config.js', './js/cloud.js', './js/seed.js', './js/views/sucursales.js',
